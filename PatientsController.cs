...
namespace HospitalMgt
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DoctorId")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,DoctorId")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
